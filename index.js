...
$(document).ready(() => {
    ...
    $.getJSON("model/productList.json", (response, status) => {
        ...
        if (status == "success") {
            ...
            document.getElementById("Home").innerHTML = `<h1>Error al mostrar los datos<h1>`
        }
    })
        ...
        let myFunctions = {
            ...
            "myButtonConfirm": function (evnt) {
                ...
                mercadoPago.configure({
                    access_token: 'TEST-8972394692505589-041913-893027ddc6a52d8dab552f6e8c6b1eb9-185705700'
                })
